...
-- This script assumes you have existing spaces, resources, and members
...
-- Insert sample members (assuming some users exist)
...
VALUES 
  ...
  ('10000000-1000-1000-1000-100000000003', 'MEM003', 'active', 'standard', '22222222-2222-2222-2222-222222222222', '2024-03-01', 125.00)
ON CONFLICT (id) DO NOTHING;
